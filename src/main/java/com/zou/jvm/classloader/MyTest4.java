...
public class MyTest4 {
    ...
    public static void main(String[] args) {
       ...
       // MyParent4 myParent4 = new MyParent4(); //输出  MyParent4  static  block

        MyParent4[] myParent4s =new MyParent4[1]; //无输出

        System.out.println(myParent4s.getClass()); //  class [Lcom.zou.jvm.classloader.MyParent4  . Java虚拟机在运行时生成.

        //二维数组
        MyParent4[][]  myParent4s1 = new MyParent4[1][1];
        System.out.println(myParent4s1.getClass()); //  class [[Lcom.zou.jvm.classloader.MyParent4;
